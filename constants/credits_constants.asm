; CreditsStrings indexes (see data/credits_strings.inc)
	const_def
	...
	const DANIEL_SCHAFERS
	const MARTINA_DEIMEL
	const PATRICK_THIERET
	const JENS_PEPPEL
	const GERMAN_TESTING_TEAM
	const EMI_BESSHO
	const TAKASHI_INAMOTO
	const HIRO_NAKAMURA
...
; CreditsScript indexes (see data/credits_script.inc)
	const_def -7
