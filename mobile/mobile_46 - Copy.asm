...
String_11a6db:
	...
	next "abgebrochen.@";"セレクト　エーでちゅうし@"

String_11a6f1:
	db   "Dieser Dienst ist";"この　サービスには"
	next "kostenpflichtig.@";"つうわりょう<NO>ほかに@"
...
String_11a70b:
	db   "Yen";"えん"
	next "Fortfahren?@";"かかります　よろしい　ですか？@"
...
String_11a755:
	db   "Die Daten jetzt";"データ<WO>よみこみますか？@"
	next "empfangen?@"
...
String_11a779:
	db   "Die Daten sind";"そのデータ<WA>なくなっているか"
	next "beschädigt.@";"こわれて　います@"

String_11a791:
	db   "Diese Daten hast"
	next "du bereits empfangen!@"
