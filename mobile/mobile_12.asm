...
MenuData_0x484f9:
	...
	db 2 ; items
Strings_484fb:
String_484fb: db "Junge@"
String_484ff: db "Mädchen@"
Strings_484fc:
String_484fc: db "  Junge@"
String_48500: db "Mädchen@"
...
.Items:
	db 73 ; The number of locations in the prefectures list (-1 because it starts at 0)
x = 0
rept 73 ; The number of locations in the prefectures list (-1 because it starts at 0)
	db x
x = x + 1
endr
	db -1
...
Burgenland:				db " AT-1@"		;Burgenland
Carinthia:				db " AT-2@"		;Carinthia
Lower_Austria:			db " AT-3@"		;Lower_Austria
Upper_Austria:			db " AT-4@"		;Upper_Austria
Salzburg:				db " AT-5@"		;Salzburg
Styria:					db " AT-6@"		;Styria
Tyrol:					db " AT-7@"		;Tyrol
Vorarlberg:				db " AT-8@"		;Vorarlberg
Vienna:					db " AT-9@"		;Vienna
Aargau:					db "CH-AG@"		;Aargau
Appenzell_Innerrhoden:	db "CH-AI@"		;Appenzell_Innerrhoden
Appenzell_Ausserrhoden:	db "CH-AR@"		;Appenzell_Ausserrhoden
...
Sankt_Gallen:			db "CH-SG@"		;Sankt_Gallen
...
Brandenburg:			db "DE-BB@"		;Brandenburg
Berlin:					db "DE-BE@"		;Berlin
Baden_Wurttemberg:		db "DE-BW@"		;Baden-Württemberg
Bayern:					db "DE-BY@"		;Bayern
Bremen:					db "DE-HB@"		;Bremen
Hessen:					db "DE-HE@"		;Hessen
Hamburg:				db "DE-HH@"		;Hamburg
Mecklenburg_Vorpommern:	db "DE-MV@"		;Mecklenburg-Vorpommern
Niedersachsen:			db "DE-NI@"		;Niedersachsen
Nordrhein_Westfalen:	db "DE-NW@"		;Nordrhein-Westfalen
Rheinland_Pfalz:		db "DE-RP@"		;Rheinland-Pfalz
Schleswig_Holstein:		db "DE-SH@"		;Schleswig-Holstein
Saarland:				db "DE-SL@"		;Saarland
Sachsen:				db "DE-SN@"		;Sachsen
Sachsen_Anhalt:			db "DE-ST@"		;Sachsen-Anhalt
Thuringen:				db "DE-TH@"		;Thüringen
Balzers:				db "LI-01@"		;Balzers
Eschen:					db "LI-02@"		;Eschen
Gamprin:				db "LI-03@"		;Gamprin
Mauren:					db "LI-04@"		;Mauren
Planken:				db "LI-05@"		;Planken
Ruggell:				db "LI-06@"		;Ruggell
Schaan:					db "LI-07@"		;Schaan
Schellenberg:			db "LI-08@"		;Schellenberg
Triesen:				db "LI-09@"		;Triesen
Triesenberg:			db "LI-10@"		;Triesenberg
Vaduz:					db "LI-11@"		;Vaduz
...
.asm_48b8d ; press up, zip code number menu
	...
	ld b, a
	and $f
	cp $a ; Defines the length of the DigitStrings list
	ld a, b
	jr c, .asm_48b9a
	and $f0
	add $ff
