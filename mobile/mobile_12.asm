...
Prefectures: ; Some names shortened to fit, check for official initials later.
	db " AT-1@"		;Burgenland
	db " AT-2@"		;Carinthia
	db " AT-3@"		;Lower_Austria
	db " AT-4@"		;Upper_Austria
	db " AT-5@"		;Salzburg
	db " AT-6@"		;Styria
	db " AT-7@"		;Tyrol
	db " AT-8@"		;Vorarlberg
	db " AT-9@"		;Vienna
	db "CH-AG@"		;Aargau
	db "CH-AI@"		;Appenzell_Innerrhoden
	db "CH-AR@"		;Appenzell_Ausserrhoden
	db "CH-BE@"		;Berne
	...
	db "CH-ZG@"		;Zug
	db "CH-ZH@"		;Zürich
	db "DE-BB@"		;Brandenburg
	db "DE-BE@"		;Berlin
	db "DE-BW@"		;Baden-Württemberg
	db "DE-BY@"		;Bayern
	db "DE-HB@"		;Bremen
	db "DE-HE@"		;Hessen
	db "DE-HH@"		;Hamburg
	db "DE-MV@"		;Mecklenburg-Vorpommern
	db "DE-NI@"		;Niedersachsen
	db "DE-NW@"		;Nordrhein-Westfalen
	db "DE-RP@"		;Rheinland-Pfalz
	db "DE-SH@"		;Schleswig-Holstein
	db "DE-SL@"		;Saarland
	db "DE-SN@"		;Sachsen
	db "DE-ST@"		;Sachsen-Anhalt
	db "DE-TH@"		;Thüringen
	db "LI-01@"		;Balzers
	db "LI-02@"		;Eschen
	db "LI-03@"		;Gamprin
	...
	db "LI-06@"		;Ruggell
	db "LI-07@"		;Schaan
	db "LI-08@"		;Schellenberg
	db "LI-09@"		;Triesen
	db "LI-10@"		;Triesenberg
	db "LI-11@"		;Vaduz
	db "LU-CA@"		;Capellen
	db "LU-CL@"		;Clervaux
	db "LU-DI@"		;Diekirch
