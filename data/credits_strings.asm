CreditsStrings:
; entries correspond to constants/credits_constants.inc
	dw .SatoshiTajiri
	dw .JunichiMasuda
	dw .TetsuyaWatanabe
	dw .ShigekiMorimoto
...
.DanielSchafers:      db "  DANIEL SCHÄFERS@"
...
.Staff:               db "      #MON"                 ; "ポケットモンスター"
	                next "  Kristall Edition"         ; "　　クりスタル　バージョン"
                    next "       Staff@"              ; "　　　　スタッフ@"
...
.MobilePrjLeader:     db "Mobil-Projektleitung@"      ; "モバイルプロジェクト　りーダー@"
.MobileSystemAd:      db "Mobil-System-Berater@"      ; "モバイル　システムアドバイザー@"
.MobileStadiumDir:    db "Ltg. MOBILES STADION@"      ; "モバイルスタジアム　ディレクター@"
